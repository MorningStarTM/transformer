...
def build_transformer(src_vocab_size:int, tgt_vocab_size:int, src_seq_len:int, tgt_seq_len:int, d_model:int=512, N:int=3, h:int=4, dropout:float=0.1, d_ff:int=2048) -> Transformer:
    ...
    # create he encoder and the decoder
